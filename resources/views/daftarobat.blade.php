...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4">
        <h1 style="text-align: center;margin-top:2%;font-family:optima">Daftar Obat</h1>
        <form action="{{ route('store1') }}" method="post">
            @csrf
           
        <div class="mb-3">
            <label for="obat_id" class="form-label">ID Obat</label>
            <input type="text" class="form-control" id="obat_id" name="obat_id"  required>
        </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="deskripsi_obat" name="deskripsi_obat" required>
            </div>
            <div class="mb-3">
            ...
            <a href="/index" class="btn btn-outline-warning">Home</a>
        </form>
    </div>
        </div>
    </div>
